...
const Code = ({ value }) => {
  ...
  return (
    <div className="group relative">
      ...
      <button
        className="absolute right-2 top-2 z-50 hidden rounded-sm bg-[#414338] px-2 py-1.5 text-[#f7f8f2] text-white duration-300 focus:outline-none group-hover:block"
        aria-label="copy"
